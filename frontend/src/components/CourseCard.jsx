  ...
  return (
    <motion.article whileHover={{ y: -6 }} className="theme-panel group overflow-hidden">
      ...
      <div className="p-7">
        ...
        <button className="mt-7 inline-flex items-center gap-2 border-b border-ink pb-1 text-xs font-black uppercase tracking-[.18em] text-ink">View curriculum <ArrowRight size={17} /></button>
      </div>
    </motion.article>
  );
}
