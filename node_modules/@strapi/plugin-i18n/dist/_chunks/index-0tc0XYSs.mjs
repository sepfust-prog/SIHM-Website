...
const index = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-ER9Mz4Ia.mjs");
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/de.json": () => import("./de-2XL3bM4-.mjs"), "./translations/dk.json": () => import("./dk-2WUZC034.mjs"), "./translations/en.json": () => import("./en-hiohckMJ.mjs"), "./translations/es.json": () => import("./es-1s8oaEg7.mjs"), "./translations/fr.json": () => import("./fr-Qu353uDy.mjs"), "./translations/hr.json": () => import("./hr-48FXCjhc.mjs"), "./translations/ko.json": () => import("./ko-INfO6xWE.mjs"), "./translations/pl.json": () => import("./pl-HMRqtUNg.mjs"), "./translations/ru.json": () => import("./ru-a8CJLIhd.mjs"), "./translations/tr.json": () => import("./tr-JhTcXfS6.mjs"), "./translations/zh-Hans.json": () => import("./zh-Hans-lDXyQOHm.mjs"), "./translations/zh.json": () => import("./zh-cn8Lojpg.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-0tc0XYSs.mjs.map
